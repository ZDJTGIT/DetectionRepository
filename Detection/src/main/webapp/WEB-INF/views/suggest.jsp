...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
			...
			<div class="col-sm-6">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<p>
							使用说明：<a href="https://github.com/lzwme/bootstrap-suggest-plugin"
								target="_blank">https://github.com/lzwme/bootstrap-suggest-plugin</a>
						</p>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<article class="markdown-body entry-content"
							...
							<h1>
								<a id="user-content-bootstrap-search-suggest" class="anchor"
									href="#bootstrap-search-suggest" aria-hidden="true"><span
									class="octicon octicon-link"></span></a>Bootstrap Search Suggest
							</h1>
							...
							<ul>
								<li>搜索方式：从 data.value 的有效字段数据中查询 keyword 的出现，或字段数据包含于
									keyword 中</li>
								<li>支持单关键字、多关键字的输入搜索建议，多关键字可自定义分隔符</li>
								<li>支持按 data 数组数据搜索、按 URL
									请求搜索和按首次请求URL数据并缓存搜索三种方式【getDataMethod】</li>
      ...
      url: "/rest/sys/getuserlist?keyword="
							...
							<p>
								具体使用请参考参数配置说明及demo 示例页面源码(<a
									href="http://lzw.me/pages/demo/bootstrap-suggest-plugin">Demo</a>)
							</p>
							...
							<h4>
								<a class="anchor"><span class="octicon octicon-link"></span></a>事件监听
							</h4>
    ...
    console.log(result);
							...
							<p>onSetSelectValue：当从下拉菜单选取值时触发，并传回设置的数据到第二个参数
								onUnsetSelectValue：当设置了 idField，且自由输入内容时触发（与背景警告色显示同步）</p>
							<h2>配置参数</h2>
							<p>参数列表中的值均为插件默认值</p>
							<pre>{
    ...
    keyEnter: 13                    //回车键
							...
							<p>请参考 index.html 文件源代码，提供了自定义数据、URL
								请求数据、百度搜索API、淘宝搜索API的接口演示。</p>
							...
							<h2>
								<a id="user-content-note-on-patches--pull-requests"
									class="anchor" href="#note-on-patches--pull-requests"
									aria-hidden="true"><span class="octicon octicon-link"></span></a>Note
							...
							<ul>
								...
								<li>Send me a pull request. Bonus points for topic
									branches.</li>
							</ul>

							<h2>
								<a id="user-content-设计制作" class="anchor" href="#设计制作"
									aria-hidden="true"><span class="octicon octicon-link"></span></a>设计制作
							</h2>

							<p>
								该插件由<a href="http://lzw.me" target="_blank">志文工作室</a>开发和维护.
							</p>
						</article>
					</div>
				</div>
		...
		var baiduBsSuggest = $("#baidu").bsSuggest(
				{
					...
					url : 'http://unionsug.baidu.com/su?p=3&t='
							+ (new Date()).getTime() + '&wd=',
