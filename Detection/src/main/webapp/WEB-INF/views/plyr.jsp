...
<body class="gray-bg">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="player">
							<video poster="../../../plyr.io/poster.jpg" controls crossorigin>
								<!-- Video files -->
					...
					<div class="ibox-content">
						<div class="player">
							<audio controls>
								<!-- Audio files -->
								<source
									src="http://music.baidu.com/cms/app/muplayer/test_mp3/1.mp3"
									type="audio/mp3">

								<!-- Fallback for browsers that don't support the <audio> element -->
								您的浏览器不支持在线播放，请
								<a href="http://music.baidu.com/cms/app/muplayer/test_mp3/1.mp3">下载</a>
							</audio>
						</div>
					</div>
				</div>
	...
	<script src="assets/js/plugins/plyr/plyr.js"></script>
	<script>
		plyr.setup();
	</script>
...
<!-- Mirrored from www.zi-han.net/theme/hplus/plyr.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:19:55 GMT -->
</html>
