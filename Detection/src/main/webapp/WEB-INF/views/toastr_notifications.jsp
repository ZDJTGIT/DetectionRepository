						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="checkbox">
											<label class="checkbox" for="addBehaviorOnToastClick">
												...
												value="checked" class="input-mini">添加Toast单击行为
											</label>
										</div>
										<div class="checkbox">
										...
										<div class="form-group" id="positionGroup">
											...
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-top-right" checked="">右上
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-bottom-right">右下
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-bottom-left">左下
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-top-left">左上
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-top-full-width">顶部全宽
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-bottom-full-width">底部全宽
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-top-center">顶部居中
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" name="positions"
													value="toast-bottom-center">底部居中
												</label>
											</div>
										</div>
									</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="showEasing">显示动画</label> <input id="showEasing"
												type="text" placeholder="swing, linear" class="form-control"
												value="swing">
										</div>
										<div class="form-group">

											<label for="hideEasing">隐藏动画</label> <input id="hideEasing"
												type="text" placeholder="swing, linear" class="form-control"
												value="linear">
										</div>
										<div class="form-group">

											<label for="showMethod">显示方法</label> <input id="showMethod"
												type="text" placeholder="show, fadeIn, slideDown"
												class="form-control" value="fadeIn">
										</div>
										<div class="form-group">

											<label for="hideMethod">隐藏方法</label> <input id="hideMethod"
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<button type="button" class="btn btn-white"
											id="clearlasttoast">清除最后一个Toast</button>
