...
<link href="assets/css/font-awesome.min93e3.css?v=4.4.0"
	rel="stylesheet">
<link href="assets/css/plugins/bootstrap-table/bootstrap-table.min.css"
	rel="stylesheet">
...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>
					Bootstrap table <a
						...
						target="_blank">http://bootstrap-table.wenzhixin.net.cn/zh-cn/</a>
				</h5>
			...
			<div class="ibox-content">
				<p>Bootstrap table是国人开发的一款基于 Bootstrap 的 jQuery
					表格插件，通过简单的设置，就可以拥有强大的单选、多选、排序、分页，以及编辑、导出、过滤（扩展）等等的功能。目前在github上已经有2600多个Star，可见其受欢迎程度。</p>
				<ul>
			...
			<div class="ibox-content">
				<div class="row row-lg">
					<div class="col-sm-6">
						...
						<div class="example">
							<table data-toggle="table" data-url="js/demo/table_base.json"
				...
				<div class="row row-lg">
						...
						<div class="example-wrap">
							...
							<div class="example">
								<table data-toggle="table"
									...
									data-url="js/demo/table_base.json" data-striped="true"
									data-height="250" data-mobile-responsive="true">
									<thead>
										<tr>
											<th data-field="Tid">ID</th>
					...
					<div class="col-sm-6">
						...
						<div class="example-wrap">
							...
							<div class="example">
								<table data-toggle="table"
									data-url="js/demo/bootstrap_table_test2.json"
									...
									<thead>
										<tr>
											...
											<th data-field="description" data-halign="left"
												data-align="right">描述</th>
										</tr>
									</thead>
								</table>
							</div>
					...
					<div class="col-sm-6">
						...
						<div class="example-wrap margin-sm-0">
							...
							<div class="example">
								<table data-toggle="table" data-url="js/demo/table_base.json"
									data-mobile-responsive="true" data-row-style="rowStyle"
									data-height="250">
									<thead>
										<tr>
											<th data-field="Tid">ID</th>
				...
				<div class="row row-lg">
					...
					<div class="col-sm-6">
						...
						<div class="example-wrap">
							...
							<div class="example">
								<table data-toggle="table" data-url="js/demo/table_base.json"
									data-height="250" data-show-header="false"
									data-mobile-responsive="true">
									<thead>
										<tr>
											<th data-field="Tid">ID</th>
				...
				<div class="row row-lg">
					...
					<div class="col-sm-6">
						...
						<div class="example-wrap margin-sm-0">
							...
							<div class="example">
								<table data-toggle="table"
									data-url="js/demo/bootstrap_table_test.json" data-height="299"
					...
					<div class="col-sm-6">
						...
						<div class="example-wrap">
							...
							<div class="example">
								<table data-toggle="table"
									data-url="js/demo/bootstrap_table_test.json" data-height="299"
									data-click-to-select="true" data-mobile-responsive="true">
									<thead>
										<tr>
	...
	<script
		src="assets/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
	<script src="assets/js/demo/bootstrap-table-demo.min.js"></script>
