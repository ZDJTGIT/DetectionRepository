			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<p>在与同类组件的比较中，layer总是能轻易获胜。她尽可能地在以更少的代码展现更强健的功能，且格外注重性能的提升、易用和实用性，正因如此，越来越多的开发者将媚眼投上了layer（已被1739623人次关注）。layer兼容了包括IE6在内的所有主流浏览器。
							她数量可观的接口，使得您可以自定义太多您需要的风格，每一种弹层模式各具特色，广受欢迎。当然，这种“王婆卖瓜”的陈述听起来总是有点难受，因此你需要进一步了解她是否真的如你所愿。</p>
						...
						<hr>
						<p>
							layer官网：<a href="http://layer.layui.com/" target="_blank">http://layer.layui.com/</a>
							<br>layer官网文档：<a href="http://layer.layui.com/api.html"
								target="_blank">http://layer.layui.com/api.html</a>
						</p>
					</div>
				</div>
			</div>
...
parent.layer.alert('内容', {
    icon: 1,
    skin: 'layer-ext-moon' //该皮肤由layer.seaning.com友情扩展。关于皮肤的扩展规则，<a
									target="_balnk" style="color: #00B2E2;"
									href="http://layer.layui.com/skin.html#publish">去这里查阅</a>
})</p>
<p>//询问框
...
$.getJSON('js/demo/photos.json', function(json){
    layer.photos({
        photos: json //格式见API文档手册页
						...
						<p>
							更多示例请访问：<a href="http://layer.layui.com/" target="_blank">http://layer.layui.com/</a>
						</p>
	...
	<script src="assets/js/demo/layer-demo.min.js"></script>
