...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="col-sm-6">
				<div class="widget navy-bg no-padding">
					<div class="p-m">
						...
						<h3 class="font-bold no-margins">年收入</h3>
						<small>项目年收入</small>
					</div>
			...
			<div class="col-sm-3">
				<div class="widget lazur-bg no-padding">
					<div class="p-m">
						...
						<h3 class="font-bold no-margins">月收入</h3>
						<small>项目年收入</small>
					</div>
					<div class="flot-chart">
			...
			<div class="col-sm-3">
				<div class="widget yellw-bg no-padding">
					<div class="p-m">
						...
						<h3 class="font-bold no-margins">半年收入</h3>
						<small>市场销售额</small>
					</div>
					<div class="flot-chart">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="widget-head-color-box navy-bg p-lg text-center">
					<div class="m-b-md">
						<h2 class="font-bold no-margins">Beaut-zihan</h2>
						<small>项目经理</small>
					</div>
					<img src="img/a4.jpg" class="img-circle circle-border m-b-md"
						alt="profile">
					<div>
						<span>100 动态</span> | <span>350 关注</span> | <span>610 关注者</span>
					</div>
				</div>
				<div class="widget-text-box">
					...
					<div class="text-right">
						<a class="btn btn-xs btn-white"><i class="fa fa-thumbs-up"></i>
							赞 </a> <a class="btn btn-xs btn-primary"><i class="fa fa-heart"></i>
							收藏</a>
					</div>
				</div>
			</div>
			<div class="col-sm-2">
				<div class="widget navy-bg p-lg text-center">
					<div class="m-b-md">
						...
						<h3 class="font-bold no-margins">安全问题</h3>
						<small>账户</small>
					</div>
				</div>
				<div class="widget  p-lg text-center">
					<div class="m-b-md">
						...
						<h3 class="font-bold no-margins">离线</h3>
						<small>账户</small>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div class="widget red-bg p-lg text-center">
					<div class="m-b-md">
						...
						<h1 class="m-xs">47</h1>
						<h3 class="font-bold no-margins">通知</h3>
			...
			<div class="col-sm-2">
				<div class="widget yellow-bg p-lg text-center">
					<div class="m-b-md">
						...
						<h3 class="font-bold no-margins">喜欢</h3>
						<small>账户</small>
					</div>
				</div>
				<div class="widget yellow-bg p-lg text-center">
					<div class="m-b-md">
						...
						<h3 class="font-bold no-margins">安全</h3>
						<small>共10个问题</small>
					</div>
				</div>
			</div>
						...
						<div>
							<div class="chat-activity-list">
								...
								<div class="chat-element">
									<a href="widgets.html#" class="pull-left"> <img alt="image"
										class="img-circle" src="img/a2.jpg">
									</a>
									<div class="media-body ">
										<small class="pull-right text-navy">1分钟前</small> <strong>奔波儿灞</strong>
										<p class="m-b-xs">跑步呐，最重要的是要有动力</p>
										<small class="text-muted">今天 09:02</small>
									</div>
								</div>

								<div class="chat-element right">
									<a href="widgets.html#" class="pull-right"> <img
										alt="image" class="img-circle" src="img/a4.jpg">
									</a>
									<div class="media-body text-right ">
										<small class="pull-left">5分钟前</small> <strong>灞波儿奔 </strong>
										<p class="m-b-xs">V信已经提前恢复，也算是个好消息吧</p>
								...
								<div class="chat-element ">
									...
									<div class="media-body ">
										<small class="pull-right">2小时前</small> <strong>奔波儿灞</strong>
										<p class="m-b-xs">是你对不对</p>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="ibox-content text-center">
								...
								<div class="text-center">
									<a class="btn btn-xs btn-white"><i class="fa fa-thumbs-up"></i>
										赞 </a> <a class="btn btn-xs btn-primary"><i
						...
						<div class="col-md-6">
							<div class="ibox-content">
								<div>
									<div>
										<span>内存</span> <small class="pull-right">10/200 GB</small>
									</div>
									...
									<div>
										<span>带宽</span> <small class="pull-right">20 GB</small>
									</div>
									<div class="progress progress-small">
									...
									<div>
										<span>占用</span> <small class="pull-right">73%</small>
									</div>
									<div class="progress progress-small">
									...
									<div>
										<span>FTP</span> <small class="pull-right">400 GB</small>
									</div>
									<div class="progress progress-small">
										<div style="width: 20%;"
			...
			<div class="col-sm-6">
				<div class="ibox-content">
					...
					<ul class="todo-list m-t">
						<li><input type="checkbox" value="" name="" class="i-checks" />
							<span class="m-l-xs">开会</span> <small class="label label-primary"><i
								class="fa fa-clock-o"></i> 1小时</small></li>
						<li><input type="checkbox" value="" name="" class="i-checks"
							checked /> <span class="m-l-xs">项目开发</span> <small
							class="label label-info"><i class="fa fa-clock-o"></i>
								3小时</small></li>
						<li><input type="checkbox" value="" name="" class="i-checks" />
							<span class="m-l-xs">修改bug</span> <small
					...
					<div class="ibox-content">
						...
						<ul class="todo-list m-t small-list">
							<li><a href="widgets.html#" class="check-link"><i
								...
								class="m-l-xs todo-completed">开会</span></li>
							<li><a href="widgets.html#" class="check-link"><i
									class="fa fa-check-square"></i> </a> <span
								class="m-l-xs  todo-completed">项目开发</span></li>
							<li><a href="widgets.html#" class="check-link"><i
									class="fa fa-square-o"></i> </a> <span class="m-l-xs">修改bug</span>
		...
		<div class="row m-t-lg">
			<div class="col-sm-12">
				<div class="ibox-content">
					<h2>世界地图</h2>
					<small>中国地图或者省份地图可使用百度前端团队提供的echarts.js。<a
						href="graph_echarts.html">百度ECharts</a></small>
	...
	<script
		src="assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script
		src="assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
