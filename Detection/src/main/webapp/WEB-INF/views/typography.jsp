			...
			<div class="col-sm-6">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<h1>
							标题 1 <small>二级标题</small>
						</h1>
						<h2>
							标题 2 <small>二级标题</small>
						</h2>
						<h3>
							标题 3 <small>二级标题</small>
						</h3>
						<h4>
							标题 4 <small>二级标题</small>
						</h4>
						<h5>
							标题 5 <small>二级标题</small>
						</h5>
						<h6>
							标题 6 <small>二级标题</small>
						</h6>
					</div>
				</div>
			</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<blockquote>
							...
							<small><strong>杜牧</strong>-<cite title=""
								data-original-title="">《寄扬州韩绰判官》</cite></small>
						</blockquote>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<address>
							<strong>阿里巴巴集团.</strong><br> 上海市闵行区绿地科技岛广场A座2606室<br> <abbr
								title="Phone">Tel:</abbr> (123) 456-7890
						</address>

						<address>
							<strong>上海市</strong><br> <a href="mailto:#">i@zi-han.net</a>
						</address>
					...
					<div class="ibox-content no-padding">
						<ul class="list-group">
							<li class="list-group-item"><span
								class="badge badge-primary">16</span> 每个人都有一个死角， 自己走不出来，别人也闯不进去。
							</li>
							<li class="list-group-item "><span class="badge badge-info">12</span>
								我把最深沉的秘密放在那里。</li>
							<li class="list-group-item"><span class="badge badge-danger">10</span>
								你不懂我，我不怪你。</li>
							<li class="list-group-item"><span
								class="badge badge-success">10</span> 每个人都有一道伤口， 或深或浅，盖上布，以为不存在。
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="list-group">
							...
							</a> <a class="list-group-item" href="typography.html#">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<div class="well well-lg">
							<h3>可选类</h3>
							通过.well-lg，.well-sm可选修饰类，可以控制此组件的内补（padding）和圆角的设置。
						</div>
					</div>
				</div>
			</div>
