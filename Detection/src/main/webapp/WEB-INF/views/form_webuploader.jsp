...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/demo/webuploader-demo.min.css">
...
<body class="gray-bg">
    ...
    <script type="text/javascript">
        var BASE_URL = 'assets/js/plugins/webuploader/index.html';
    </script>
    <script src="assets/js/plugins/webuploader/webuploader.min.js"></script>
    <script src="assets/js/demo/webuploader-demo.min.js"></script>
