...
<body class="gray-bg">
    ...
    <script type="text/javascript" src="assets/plugins/fullavatareditor/scripts/swfobject.js"></script>
    <script type="text/javascript" src="assets/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
    <script type="text/javascript" src="assets/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
    <script type="text/javascript" src="assets/plugins/fullavatareditor/scripts/test.js"></script>
