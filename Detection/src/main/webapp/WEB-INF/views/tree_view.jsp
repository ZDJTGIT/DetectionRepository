...
<link href="assets/css/plugins/treeview/bootstrap-treeview.css"
	rel="stylesheet">
...
<body class="gray-bg">
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<p>
						Bootstrap Tree View 是一个简单而优雅的Bootstrap树形视图解决方案。 <br>您可以访问作者的
						<a href="https://github.com/jonmiles/bootstrap-treeview"
							target="_blank">GitHub页面</a> 了解其用法及更多信息。
					</p>
				</div>
			</div>
		</div>
	...
	<script src="assets/js/demo/treeview-demo.min.js"></script>
