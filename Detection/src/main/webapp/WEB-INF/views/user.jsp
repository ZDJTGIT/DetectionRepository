                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title">Rojay<br />
                                     <a href="#"><small>@Rojay</small></a>
                                  </h4>
                                </div>
                            ...
                            <div class="text-center">
                                <div class="row">
                                    <div class="col-md-3 col-md-offset-1">
                                        <h5>12<br /><small>文件</small></h5>
                                    </div>
                                    <div class="col-md-4">
                                        <h5>2GB<br /><small>Used</small></h5>
                                    </div>
                                    <div class="col-md-3">
                                        <h5>24,6$<br /><small>余额</small></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
				...
				<div class="copyright pull-right">
                   Copyright &copy; 2017.湖南中大建设工程检测技术有限公司.<a target="_blank" href="http://www.hnzdjc.com/">湖南中大检官网</a>
                </div>
            </div>
        </footer>
