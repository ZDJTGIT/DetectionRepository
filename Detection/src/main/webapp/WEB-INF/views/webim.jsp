...
<link href="assets/css/plugins/morris/morris-0.4.3.min.css"
	rel="stylesheet">
<!-- Gritter -->
<link href="assets/js/plugins/gritter/jquery.gritter.css"
	rel="stylesheet">
<link href="assets/js/plugins/layer/layim/layim.css" rel="stylesheet">
</head>
<body class="gray-bg">
	<div class="row">
		<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<hr>
								<p>
									作者：<a href="http://sentsin.com/" target="_blank">贤心</a>
								</p>
							</div>
						</div>
					...
					<div class="col-sm-6">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<div class="alert alert-info">请在右下角的窗口中查看。</div>
							</div>
						</div>
...
&lt;/html&gt;</pre>
									...
									<li class="list-group-item">
										...
										</p> <br> <pre>在js/plugins/layer/layer.min.js中找到如下内容，进行自定义设置：
