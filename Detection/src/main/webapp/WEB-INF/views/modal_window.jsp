			...
			<div class="col-sm-4">
					...
					<div class="ibox-content">
						...
						<div class="text-center">
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#myModal">打开示例窗口</button>
						</div>
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label>Email</label> <input type="email"
												placeholder="请输入您的Email" class="form-control">
										</div>
									</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<div class="text-center">
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#myModal5">大模态窗口</button>
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#myModal6">小模态窗口</button>
						</div>
			...
			<div class="col-sm-8">
				<div class="ibox ">
					...
					<div class="ibox-content">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal"
							data-target="#myModal2">沿X轴转动</button>
						...
						<button type="button" class="btn btn-primary" data-toggle="modal"
							data-target="#myModal4">基本动画</button>
				...
				<div class="ibox ">
					...
					<div class="ibox-content">
						<p>
							可以通过数据绑定或者Javascript来实现模态窗口的相关功能，如果使用数据绑定，可以为元素添加
							<code>data-</code>
							，如
							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									<tr>
										...
										<td>true</td>
										<td>遮罩层，或使用<code>'static'</code>指定遮罩层与关闭模态窗口不关联
										</td>
									</tr>
									<tr>
										<td>keyboard</td>
									...
									<tr>
										...
										<td>
											<p>
												<strong class="text-danger">推荐使用数据绑定方式，或使用<a
													href="http://api.jquery.com/load/">jQuery.load</a>
											</p>
											<p>远程URL示例：</p>
											<div class="highlight">
												<pre>
													<code class="language-html" data-lang="html">
														<span class="nt">&lt;a</span> <span class="na">data-toggle=</span><span
															class="s">"modal"</span> <span class="na">href=</span><span
															class="s">"remote.html"</span> <span class="na">data-target=</span><span
															class="s">"#modal"</span><span class="nt">&gt;</span>Click me<span
															class="nt">&lt;/a&gt;</span>
													</code>
												</pre>
											</div>
...
<!-- Mirrored from www.zi-han.net/theme/hplus/modal_window.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:19:56 GMT -->
</html>
