...
//                                              {name: '标线1终点', xAxis: '周日', yAxis:5},             // 当xAxis为类目轴时，字符串'周三'会被理解为与类目轴的文本进行匹配
    ...
    var OsmoticpressureChart = echarts.init(document.getElementById("echarts-Osmoticpressure-chart"));
    var Osmoticpressureoption = {
        tooltip : {
                            trigger : 'axis'
                        },
                        legend : {
    ...
    OsmoticpressureChart.setOption(Osmoticpressureoption);
    $(window).resize(OsmoticpressureChart.resize);
    
    var opGrandtotalChart = echarts.init(document.getElementById("echarts-opGrandtotal-chart"));
    var opGrandtotaloption = {
        tooltip : {
                            trigger : 'axis'
                        },
                        legend : {
    ...
    opGrandtotalChart.setOption(opGrandtotaloption);
    $(window).resize(opGrandtotalChart.resize);

    var oprateChart = echarts.init(document.getElementById("echarts-oprate-chart"));
    var oprateoption = {
        tooltip : {
                            trigger : 'axis'
                        },
    ...
    oprateChart.setOption(oprateoption);
    $(window).resize(oprateChart.resize);
    
    var rainfallsingleChart = echarts.init(document.getElementById("echarts-rainfallsingle-chart"));
    var rainfallsingleoption = {
        tooltip : {
                            trigger : 'axis'
                        },
                        legend : {
    ...
    rainfallsingleChart.setOption(rainfallsingleoption);
    $(window).resize(rainfallsingleChart.resize);
    
    var rafGrandtotalChart = echarts.init(document.getElementById("echarts-rafGrandtotal-chart"));
    var rafGrandtotaloption = {
        tooltip : {
                            trigger : 'axis'
                        },
                        legend : {
    ...
    rafGrandtotalChart.setOption(rafGrandtotaloption);
    $(window).resize(rafGrandtotalChart.resize);
    
    var rafrateChart = echarts.init(document.getElementById("echarts-rafrate-chart"));
    var rafrateoption = {
        tooltip : {
                            trigger : 'axis'
                        },
    ...
    rafrateChart.setOption(rafrateoption);
    $(window).resize(rafrateChart.resize);
