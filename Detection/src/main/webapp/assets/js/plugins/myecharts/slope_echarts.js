$(function() {
	...
	// 深部
	var deepsingleChart = echarts.init(document
			.getElementById("echarts-deepsingle-chart"));
	var deepsingletion = {
		tooltip : {
			trigger : 'axis'
		},
	...
	var deepgrandtotalChart = echarts.init(document
			.getElementById("echarts-deepgrandtotal-chart"));
	...
	var deeprateChart = echarts.init(document
			.getElementById("echarts-deeprate-chart"));
	var deepratetion = {
		tooltip : {
			trigger : 'axis'
		},
	...
	// 雨量
	var rainfallsingleChart = echarts.init(document
			.getElementById("echarts-rainfallsingle-chart"));
	...
	var rainfallgrandtotalChart = echarts.init(document
			.getElementById("echarts-rainfallgrandtotal-chart"));
	...
	var rainfallrateChart = echarts.init(document
			.getElementById("echarts-rainfallrate-chart"));
