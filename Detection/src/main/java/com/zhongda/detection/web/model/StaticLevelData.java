...
public class StaticLevelData {
	...
	public void setSmuCmsChannel(String smuCmsChannel) {
		this.smuCmsChannel = smuCmsChannel == null ? null : smuCmsChannel
				.trim();
	}
	...
	public String toString() {
		return "StaticLevelData [id=" + id + ", sensorId=" + sensorId
				+ ", currentTimes=" + currentTimes + ", currentData="
				+ currentData + ", currentTemperature=" + currentTemperature
				+ "]";
	}
