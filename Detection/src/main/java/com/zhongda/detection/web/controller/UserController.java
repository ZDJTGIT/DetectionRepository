...
public class UserController {
	...
	public void OnlyPassword(String password, Integer userId, HttpServletResponse response){
		String sqlpassword = userService.selectByPrimaryKey(userId).getPassword();
	...
	public void sendemail(String emailAddress, String userName){
		...
		String congtent = userName+": 你好，您正在进行改密操作，请确认是你本人操作！    ---中大检测数据监测平台";
